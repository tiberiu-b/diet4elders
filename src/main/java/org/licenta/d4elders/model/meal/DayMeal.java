...
public class DayMeal extends BasicMeal implements Comparable<DayMeal> {
	...
	public Map<String, Double> computeNutrientsValues() {
		nutrientsValuesMap = MapHelper.addNutrientsMaps(breakfast.computeNutrientsValues(),
				lunch.computeNutrientsValues(), dinner.computeNutrientsValues(), snack1.computeNutrientsValues(),
