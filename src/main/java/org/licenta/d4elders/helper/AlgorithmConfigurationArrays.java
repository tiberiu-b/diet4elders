...
public class AlgorithmConfigurationArrays {
	private static final Logger log = Logger.getLogger(AlgorithmConfigurationArrays.class.getName());
	...
	private void populateEmptyArray() {
		...
		if(broodModificationStrategy.isEmpty())
			broodModificationStrategy.add(config.getBroodModificationStrategy());
		if(workerModificationStrategies.isEmpty())
			workerModificationStrategies.add(config.getWorkerModificationStrategies());
		...
		if(probabilityToMateDroneThreshold.isEmpty())
			probabilityToMateDroneThreshold.add(config.getProbabilityToMateDroneThreshold());
		if(similarityCoefficientThreshold.isEmpty())
			similarityCoefficientThreshold.add(config.getSimilarityCoefficientThreshold());
