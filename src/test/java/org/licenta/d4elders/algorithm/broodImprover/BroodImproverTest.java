...
public class BroodImproverTest {
	...
	/**
	 * Checks whether the solution resulted from the algorithm has a greater
	 * fitness value. Runs NUMBER_OF_RUNS times. This is great to
	 * discover/compute the annealing schedule.
	 */
	@Test
	public void testImprove() {
		...
		sol = new SimulatedAnnealingBroodImprover(new AnnealingScheduler(1, 90,
				0.1)).improve(sol);
	...
	/**
	 * Tests whether the average of the improved set is greater. Tests whether
	 * using 4 threads is faster than 1 thread.
	 */
	@Test
	public void testImproveCollection() {
		final int size = 1000;
		RandomSolutionsGenerator gen = new RandomSolutionsGenerator();
		SortedSet<Solution> solutions = gen.generateRandomSolutions(size);
